...
public class Task {
    ...
    @ManyToOne(fetch = FetchType.LAZY) // this means that tasklist will not be loaded from the db unless it is needed.
    @JoinColumn(name = "task_list_id") //name of the foreign key field in the tasks table
